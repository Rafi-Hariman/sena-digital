...
@Component({
  selector: 'wc-modal-add-website-category',
  templateUrl: './modal-add-website-category.component.html',
  styleUrls: ['./modal-add-website-category.component.scss']
})
export class ModalAddWebsiteCategoryComponent implements OnInit {
  ...
  onImageSelected(event: any) {
    ...
    if (file) {
      ...
      // Generate preview
      this.websiteCategoryService.generateImagePreview(file)
        .then(preview => {
  ...
  onAddCategory() {
    ...
    this.websiteCategoryService.createCategory(formData)
      .subscribe({
        next: (result) => {
          this.uploading = false;
          if (result.success) {
            this.notyf.success('Website category created successfully!');
            this.modalSvc.hide();
